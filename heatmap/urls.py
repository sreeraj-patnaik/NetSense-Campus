...
urlpatterns = [
    ...
    path("brand/logo-with-name.png", views.brand_logo_with_name, name="brand_logo_with_name"),
    path("brand/logo-without-name.png", views.brand_logo_without_name, name="brand_logo_without_name"),
